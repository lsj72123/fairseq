...
def load_checkpoint(cfg: CheckpointConfig, trainer, **passthrough_args):
    ...
    *passthrough_args* will be passed through to
    ...
    if cfg.restore_file == "checkpoint_last.pt":  # default value of restore_file is 'checkpoint_last.pt'
    ...
    extra_state, bexists = trainer.load_checkpoint(
        checkpoint_path,
        reset_optimizer,
        reset_lr_scheduler,
        optimizer_overrides,
    ...
    if extra_state is not None and not reset_dataloader:    # todo
    ...
    return extra_state, epoch_itr, bexists
...
def prune_state_dict(state_dict, model_cfg: Optional[DictConfig]):  # todo: after read the original paper
