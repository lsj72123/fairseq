...
class Dictionary:
    ...
    def encode_line(
            self, line, line_tokenizer=tokenize_line,
            add_if_not_exist=True, consumer=None, append_eos=True, reverse_order=False,
    ) -> torch.IntTensor:
        ...
        if append_eos:
            ids[nwords] = self.eos()
        return ids  # ids is the converted line with eos
